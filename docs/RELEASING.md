...
9. Confirm the [`Publish to WinGet`](../.github/workflows/winget.yml) workflow verifies the published Windows release asset and opens the update PR after the tag-triggered Release workflow completes.
