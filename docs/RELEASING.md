...
9. Confirm the [`Publish to WinGet`](../.github/workflows/winget.yml) workflow opens the update PR after the successful tag-triggered Release workflow completes.
