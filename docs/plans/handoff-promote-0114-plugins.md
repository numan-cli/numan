...
- `PRE_0_112`: clipboard (superseded by Nushell 0.111+ core `clip` command; not a numan candidate), dbus (0.101), audio_hook (0.110), vec (0.105), from_beancount (0.76), nuts (0.110)
