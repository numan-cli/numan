...
def render_formula(version: str, digests: dict[str, str]) -> str:
    ...
    if linux_arm is not None:
        linux_arm_block = f"""
    on_arm do
      url "https://github.com/numan-cli/numan/releases/download/v#{{version}}/numan-#{{version}}-aarch64-unknown-linux-gnu.tar.gz"
      sha256 "{linux_arm}"
    end"""
...
class Numan < Formula
  ...
  homepage "https://github.com/numan-cli/numan"
  version "{version}"
  license "MIT"

  on_macos do
    on_arm do
      url "https://github.com/numan-cli/numan/releases/download/v#{{version}}/numan-#{{version}}-aarch64-apple-darwin.tar.gz"
      sha256 "{mac_arm}"
    end
    on_intel do
  ...
  on_linux do
    on_intel do
      url "https://github.com/numan-cli/numan/releases/download/v#{{version}}/numan-#{{version}}-x86_64-unknown-linux-gnu.tar.gz"
      sha256 "{linux_intel}"
    end{linux_arm_block}
  end
