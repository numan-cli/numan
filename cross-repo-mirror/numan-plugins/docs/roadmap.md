...
[**`numan/docs/plans/consolidated-multi-repo-roadmap.md`**](https://github.com/tonythethompson/numan/blob/f242dea6d776c753665fea6f5527aa3ab935d99a/docs/plans/consolidated-multi-repo-roadmap.md)

The cross-repo drill is enforced by
[`scripts/check-roadmap-drift.py`](https://github.com/tonythethompson/numan/blob/f242dea6d776c753665fea6f5527aa3ab935d99a/scripts/check-roadmap-drift.py),
