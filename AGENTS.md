...
src/
  ...
  cmd/
    ...
    use_cmd.rs         — `numan use <version>|latest|list`: selects an installed Nu via active-version marker (`nu_state/active-version.json`); runs legacy migration when needed; no auto-download
