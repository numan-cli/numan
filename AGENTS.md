...
- Near-term adoption bottleneck is catalog depth and multi-OS first-use demos; release handoff is numan-plugins → numan-registry → numan client. Live catalog overview: `numan-registry/docs/catalog-compat.md`; plugin candidates: `numan-plugins/docs/backlog.json`.
